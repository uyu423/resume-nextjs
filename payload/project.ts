...
const mukbank: IProject.Item = {
  title: '먹뱅크 (리액트 네이티브 기반의 맛집 추천 앱)',
  startedAt: '2020-03',
  endedAt: '2020-04',
  where: 'Back-end (Leader)',
  descriptions: [
    {
      content:
        '초반 프로젝트 진행을 위해 라우터 및 사용할 모듈 Nodejs-express 서버 세팅하여 빠른 프로젝트 진행에 기여.',
    },
    {
      content: '로그인 처리시 JWT 인증 로직 적용하여 서버 부담 경감.',
    },
    {
      content: '사용자 편리성을 높이기 위해 리액트 네이티브에서 소셜 로그인, 로그아웃 기능 구현.',
    },
    { content: '선택한 음식 카테고리를 저장하고 가져오는 로직 작성을 통한 유저 편의성 증대.' },
    {
      content:
        'AWS EC2 배포 및 https 적용을 위한 도메인 구매, AWS ELB에 AWS-SSL인증서 적용을 통해 통신 보안성 향상.',
    },
    { content: '부하 분산을 위해 AWS ELB 이용 인스턴스 2개로 스케일 아웃 적용.' },
    { content: '안정적인 서비스를 위해 AWS CloudWatch-Slack 연동 ELB 요청건수 모니터링.' },
    {
      content:
        '앱 초기 시안 작성  및 기존 가게 데이터 검증을 위해 공공데이터 음식점 현황  sql 파일 생성.',
    },
    { content: '데이터 시각화를 위해 Kibana를 이용 간단하게 가게수, 서울 지역 가게 분포도 적용. ' },
    {
      content: '프로젝트 소개 노션 페이지',
      href: 'https://www.notion.so/3-ToNaEat-MukBank-a87f0fa125d14655b4040433da09da56',
    },
  ],
};

const zeminia: IProject.Item = {
  title: '제미니아 (리액트 기반 턴제 RPG 웹게임)',
  startedAt: '2020-03',
  endedAt: '2020-03',
  where: 'Back-end',
  descriptions: [
    {
      content: '빠른 프로젝트 진행을 위해 라우터 및 사용할  모듈 Nodejs-express 서버 초기 세팅.',
    },
    {
      content:
        '로그인, 로그아웃시 안정적인 유저 세션 관리를 위해 express-mysql-session 스토어 적용.',
    },
    {
      content:
        '재미요소를 높이기 위해 게임내 실시간 채팅 구현을 위해 리액트 클라이언트- Nodejs 서버간 socket.io 적용.',
    },
    {
      content: '추후 유지보수 및 효율적인 코드 관리를 위해 sequelize orm 이용 유저 api 제작.',
    },
    {
      content:
        '몬스터 이미지 및 능력치 관리를 위해 이미지 업로드 기능(Multer 모듈 이용)  api 작성.',
    },
  ],
};
